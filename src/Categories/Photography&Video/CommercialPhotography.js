...
const CommercialPhotography = () => {
  ...
  return (
    ...
    <div className="first-container">
     <h1>Commercial Photography Courses</h1>
...
{data.filter((item)=>item.category==="Photography").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="Photography2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="Photography3").map((item,index)=>{
  console.log(item)
return(
