...
const OtherITsoftware = () => {
  ...
  return (
    ...
    <div className="first-container">
     <h1>Other IT & Software Courses</h1>
...
{data.filter((item)=>item.category==="otherIT").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="otherIT2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="otherIT3").map((item,index)=>{
  console.log(item)
return(
