...
{data.filter((item)=>item.category==="Networksecurity").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="Networksecurity2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="Networksecurity3").map((item,index)=>{
  console.log(item)
return(
