...
{data.filter((item)=>item.category==="ITSoftware").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="ITSoftware2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="ITSoftware3").map((item,index)=>{
  console.log(item)
return(
