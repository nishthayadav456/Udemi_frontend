...
const OperatingSystem = () => {
  ...
  return (
    ...
    <div className="first-container">
     <h1>Operating Systems & Servers Courses</h1>
...
{data.filter((item)=>item.category==="operating").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="operating2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="operating3").map((item,index)=>{
  console.log(item)
return(
