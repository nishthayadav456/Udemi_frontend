...
return (
  ...
  <div className="first-container">
   <h1>Social Media Marketing Courses</h1>
...
{data.filter((item)=>item.category==="marketing").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="marketing2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="marketing3").map((item,index)=>{
console.log(item)
return(
