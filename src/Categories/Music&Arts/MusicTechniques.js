...
return (
  ...
  <div className="first-container">
   <h1>Music Techniques Courses</h1>
...
{data.filter((item)=>item.category==="music").map((item,index)=>{
console.log(item)
return(
 <div>
...
export default  MusicTechniques
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="music2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="music3").map((item,index)=>{
console.log(item)
return(
