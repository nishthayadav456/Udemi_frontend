...
{data.filter((item)=>item.category==="health").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="health2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="health3").map((item,index)=>{
console.log(item)
return(
