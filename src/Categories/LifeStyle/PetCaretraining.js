...
return (
  ...
  <div className="first-container">
   <h1>Pet Care & Training Courses</h1>
...
{data.filter((item)=>item.category==="lifestyle").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="lifestyle2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="lifestyle3").map((item,index)=>{
console.log(item)
return(
