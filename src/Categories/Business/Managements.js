...
{data.filter((item)=>item.category==="management").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="management2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="management3").map((item,index)=>{
console.log(item)
return(
