...
{data.filter((item)=>item.category==="Humanresource").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="Humanresource2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="Humanresource3").map((item,index)=>{
console.log(item)
return(
