...
{data.filter((item)=>item.category==="communication").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="communication2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="communication3").map((item,index)=>{
  console.log(item)
return(
