...
{data.filter((item)=>item.category==="operations").map((item,index)=>{
  console.log(item)
return(
   <div>
    ...
    <div>
      <table className="table1">
        <tr className="tr">
          ...
          <td>Lean</td>
          <td>Virtual Assistant skills</td>
          <td>Six Sigma</td>
        </tr>
        <tr className="tr">
          <td>Quality Management</td>
          <td>Operation Management</td>
          <td>Certified Quality Auditor</td>
          <td>RPA Robotic process</td>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="operation2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="operation3").map((item,index)=>{
  console.log(item)
return(
