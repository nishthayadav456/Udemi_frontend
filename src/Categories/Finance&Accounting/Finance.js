...
{data.filter((item)=>item.category==="finance").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="finance2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="finance3").map((item,index)=>{
console.log(item)
return(
