...
{data.filter((item)=>item.category==="Taxes").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="Taxes2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="Taxes3").map((item,index)=>{
console.log(item)
return(
