...
return (
  ...
  <div className="first-container">
   <h1>Accounting & Bookkeeping Courses</h1>
...
{data.filter((item)=>item.category==="bookkeeping").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="bookkeeping2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="bookkeeping3").map((item,index)=>{
console.log(item)
return(
