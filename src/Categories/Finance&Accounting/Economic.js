...
{data.filter((item)=>item.category==="Economic").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="Economic2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="Economic3").map((item,index)=>{
console.log(item)
return(
