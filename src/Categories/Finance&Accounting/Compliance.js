...
{data.filter((item)=>item.category==="compliance").map((item,index)=>{
console.log(item)
return(
 <div>
...
useEffect(()=>{
  ...
  return(
    ...
    {data.filter((item)=>item.category==="compliance2").map((item,index)=>{
console.log(item)
return(
 <div>
...
{data.filter((item)=>item.category==="compliance3").map((item,index)=>{
console.log(item)
return(
