...
{data.filter((item)=>item.category==="gamedesign").map((item,index)=>{
  console.log(item)
return(
   <div>
...
function Business2(){
  ...
  useEffect(()=>{
    ...
    return(
      ...
      {data.filter((item)=>item.category==="gamedesign2").map((item,index)=>{
  console.log(item)
return(
   <div>
...
return(
  ...
  {data.filter((item)=>item.category==="gamedesign3").map((item,index)=>{
  console.log(item)
return(
